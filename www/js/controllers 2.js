...
/*    function loadRoom(){
    ...
    //  loader.load("models/3D_Room_test/room.js",function(geometry,materials){
      loader.load(" models/DOSCH/24/blender.js",function(geometry,materials){
      ...
      $scope.loadRoom = function(){
        ...
        mtlLoader.load( 'office_new.mtl', function( materials ) {
          materials.preload();
          var objLoader = new THREE.OBJLoader();
          objLoader.setMaterials( materials );
          objLoader.setPath( 'models/TEST/' );
          objLoader.load( 'office_new.obj', function ( object ) {
            //mesh = object;
